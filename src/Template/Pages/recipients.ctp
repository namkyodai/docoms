...
$this->assign('title', 'DoCoMS: About Recipients');
?>
...
<div class="col-md-12">
  <div class="panel panel-info">
    ...
    <div class="panel-body">
      <p>
        The List Recipients menu item will allow you to view all the relevant data regarding the recipients in the DoCoMS database. Depending on your user privileges, you can also add, edit or delete recipients in the database. You can also export the data of all the recipients to an Excel file.
      </p>
    </div>
  </div>
</div>
