...
$this->assign('title', 'DoCoMS: About Senders');
?>
...
<div class="col-md-12">
  <div class="panel panel-info">
    ...
    <div class="panel-body">
      <p>
        The List Senders menu item will allow you to view all the relevant data regarding the senders in the DoCoMS database. Depending on your user privileges, you can also add, edit or delete senders in the database. You can also export the data of all the senders to an Excel file.
      </p>
    </div>
  </div>
</div>
