...
$this->assign('title', 'DoCoMS: Admin Menu');
?>
...
<div class="col-md-12">
  <div class="panel panel-info">
    ...
    <div class="panel-body">
      <p>
        The Admin Menu will allow you to manage all registered users of DoCoMS. Only administrators can add, edit or delete users in the database. Other user types can edit their profile data only.
      </p>
    </div>
  </div>
</div>
    ...
    <div class="panel-body">
      ...
      <p>
        ...
        <dl>
          ...
          <dd>Check the box to make the user active, i.e. enable the user to login and use DoCoMS.</dd>
          <dt>First Name</dt>
