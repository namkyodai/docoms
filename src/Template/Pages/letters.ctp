...
$this->assign('title', 'DoCoMS: About Letters');
?>
...
<div class="col-md-12">
  <div class="panel panel-info">
    ...
    <div class="panel-body">
      <p>
        The List Letters menu item will allow you to view all the relevant data regarding a letter in the DoCoMS database. Depending on your user privileges, you can also add, edit or delete letters in the database. You can also export the data of all the letters to an Excel file.
      </p>
    </div>
  </div>
</div>
