...
$this->assign('title', 'DoCoMS: Work Breakdown Structure (WBS)');
?>
...
<div class="col-md-12">
  <div class="panel panel-info">
    ...
    <div class="panel-body">
      <p>
        DoCoMS assumes that letters are issued in relation to WP. As such, the letters are named and organized accordingly. Please refer to <?= $this->Html->link('Letter Naming', ['controller' => 'Pages', 'action' => 'letternaming', 'plugin' => false]) ?> for details regarding the letter naming convention.</p>
      <p>
    </div>
  </div>
</div>
