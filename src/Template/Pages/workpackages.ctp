...
$this->assign('title', 'DoCoMS: About Work Packages');
?>
...
<div class="col-md-12">
  <div class="panel panel-info">
    ...
    <div class="panel-body">
      <p>
        The List Work Packages menu item will allow you to view all the relevant data regarding the work packages in the DoCoMS database. Depending on your user privileges, you can also add, edit or delete work packages in the database. You can also export the data of all the work packages to an Excel file.
      </p>
    </div>
  </div>
</div>
