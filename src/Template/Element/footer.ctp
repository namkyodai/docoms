			...
			<div class="container">
				<div class="clearfix">
					<div class="footer-logo">
						<?= $this->Html->image('main.png', ['height' => '50px', 'alt' => 'DoCoMS', 'url' => ['controller' => 'Pages', 'action' => 'home', 'plugin' => false]]) ?>
						<?= $this->Html->link('DoCoMS', ['controller' => 'Pages', 'action' => 'home', 'plugin' => false]) ?>
					</div>
						<dl class="footer-nav">
							<dt class="nav-title">ABOUT</dt>
							<dd class="nav-item">
								<?= $this->Html->link('> What is DoCoMS?', ['controller' => 'Pages', 'action' => 'whatiscocoms', 'plugin' => false]) ?>
							</dd>
							<dd class="nav-item">
					...
					<div class="footer-copyright text-center">
						Copyright &copy; <a href="http://www.pomplus.vn">POMPLUS Consulting Co. Ltd</a>
					</div>
				</div>
      </div>
  </div>
